            ...
            {data.length === 0 ? (
                ...
                {processedData.map((item, idx) => {
                    ...
                    const valueStyle = isFirst
                        ...
                        : isSelected
                            ? (isSemi ? 'bg-amber-500/20 text-amber-900 dark:text-amber-200 border border-amber-500/40 font-semibold' : 'bg-primary-100 dark:bg-primary-800/50 text-primary-800 dark:text-primary-300 border border-primary-300 dark:border-primary-600 font-semibold')
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`relative flex-1 h-[24px] rounded-full ${isSemi ? 'bg-amber-500/10 dark:bg-amber-950/30' : 'bg-primary-50/50 dark:bg-neutral-800/50'} overflow-hidden min-w-0 flex items-center`}>
                                {/* Fill proporcional */}
                                <div
