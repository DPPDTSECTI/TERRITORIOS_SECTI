...
export default function CustomPieChart({
 ...
 <span className="text-text-primary font-medium text-[20px] leading-none mb-1 tracking-tight transition-all duration-300">
 ...
 <h3 className="text-text-muted font-semibold text-[10px] uppercase mb-3 truncate">
 {listTitle}
 </h3>
 ...
 <div className={`w-[20px] h-[20px] rounded-md ${item.color || 'bg-primary-600/10'} ${item.text || 'text-primary-600'} flex items-center justify-center font-bold text-[9px] shadow-sm shrink-0`}>
 {item.rank || idx + 1}º
 </div>
