    ...
    <div data-tutorial="kpis">
      ...
      <div className="flex overflow-x-auto sm:overflow-visible snap-x hide-scroll sm:grid sm:grid-cols-3 lg:grid-cols-5 gap-3 pb-2 sm:pb-0">
        {[
          ...
          { l: 'Cursos de CT&I', v: dashboardData.topKpis.cursos, pct: dashboardData.topKpisPct.cursos, c: darkMode ? 'text-blue-400' : 'text-[#0F4C81]', b: 'bg-[#0F4C81]', icon: <GraduationCap size={14} />, tr: true, sourceText: 'INEP / Censo da Educação Superior (2024)', sourceLink: 'https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/censo-da-educacao-superior', listType: 'cursos' },
...
export function SubKpiPanel(props) {
  ...
  const subKpisList = useMemo(() => {
    ...
    const items = [
      { id: 'campiUniversidadePublica', l: 'Campi Univ. Públicas', v: totals.campiUniversidadePublica, c: singleColorClass, b: singleBarClass, sourceText: 'INEP / Censo da Educação Superior (2024)', sourceLink: 'https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/censo-da-educacao-superior' },
      { id: 'campiUniversidadePrivada', l: 'Campi Univ. Privadas', v: totals.campiUniversidadePrivada, c: singleColorClass, b: singleBarClass, sourceText: 'INEP / Censo da Educação Superior (2024)', sourceLink: 'https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/censo-da-educacao-superior' },
      { id: 'campiInstitutoFederal', l: 'Campi Inst. Federais', v: totals.campiInstitutoFederal, c: singleColorClass, b: singleBarClass, sourceText: 'INEP / Censo da Educação Superior (2024)', sourceLink: 'https://www.gov.br/inep/pt-br/acesso-a-informacao/dados-abertos/microdados/censo-da-educacao-superior' },
