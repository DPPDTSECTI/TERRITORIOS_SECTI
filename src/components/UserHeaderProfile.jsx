      ...
      <div className="tour-user-menu flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="tour-help-button w-9 h-9 rounded-full bg-white text-[#457B9D] hover:text-[#1D3557] hover:bg-[#D6EAF8]/50 flex items-center justify-center transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-0.5 active:scale-90 shadow-[0_2px_10px_rgba(29,53,87,0.04)]"
          >
