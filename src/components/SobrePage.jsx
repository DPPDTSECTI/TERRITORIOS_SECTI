...
function SectionTitle({ title, subtitle }) {
  return (
    <div className="flex flex-col gap-1.5 mb-6">
      ...
      {subtitle && (
        <p className="text-sm text-text-secondary font-normal leading-relaxed max-w-3xl">
          {subtitle}
        </p>
      )}
    </div>
    ...
    <main className="flex-1 h-screen overflow-y-auto overflow-x-hidden relative bg-background font-sans w-full scroll-smooth">
      <div className="w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-14 py-8 lg:py-12 flex flex-col gap-12">
        ...
        <header className="flex flex-col items-start gap-3">
          ...
          <p className="text-base sm:text-lg max-w-4xl leading-relaxed text-text-primary font-normal mt-1">
          ...
          <p className="text-sm sm:text-base max-w-4xl leading-relaxed text-text-secondary font-normal">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 hover:underline underline-offset-4 transition-colors mt-1"
          >
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <section className="rounded-2xl bg-surface p-6 sm:p-8 text-text-primary border border-border shadow-xs">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3.5">
                {[
                  ...
                  <div key={i} className="bg-surface-soft rounded-xl p-4 border border-border flex flex-col justify-between hover:border-border-strong transition-colors">
                    <div>
                      <strong className="block text-sm font-semibold text-text-primary tracking-tight mb-0.5">
                        {cat.titulo}
                      </strong>
                      <span className="inline-block text-[11px] font-medium text-text-muted mb-2">
                        {cat.siglas}
                      </span>
                ...
                <div className="bg-surface-soft border border-border rounded-xl p-4 flex flex-col justify-center">
                  <span className="text-xs font-semibold uppercase tracking-wider text-text-primary block mb-1">
                    Critério & Ordenação
                  </span>
                  <p className="text-xs text-text-secondary leading-relaxed font-normal">
                    O painel compara a proporção <strong className="text-text-primary font-semibold">Com RNP</strong> vs. <strong className="text-text-primary font-semibold">Sem RNP</strong> por categoria e território, ordenando os registros estritamente em ordem <strong className="text-text-primary font-semibold">decrescente (DESC)</strong> para identificar prioridades estratégicas de expansão.
                  </p>
                </div>
              </div>
            </div>
            ...
            {secoesPlataforma.map((sec, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    to={sec.rota}
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors pt-3 border-t border-border"
                  >
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              >
                <div>
                  <span className="text-xs font-mono font-bold text-text-muted block mb-2">
                    ETAPA {step.passo}
                  </span>
